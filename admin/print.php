...
header h1 { background: #792685; border-radius: 0.25em; color: #FFF; margin: 0 0 1em; padding: 0.5em 0; }
...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>UNGUIN HOTEL,</p>
				<p>JL.Palagan,<br>Ringroad Utara,<br>Yogyakarta</p>
				<p>0832-0853-8751</p>
			</address>
			<span><img alt="" src="logo.png" style="width: 40%"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
			<p align="center">Email :- contact.ungu@gmail.com || Phone :- 0832-0853-8751 </p>
...
$free="Free";
$nul = null;
$rpsql = "UPDATE `room` SET `cusid`='$nul' where `cusid`='$id'";
