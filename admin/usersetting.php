...
?>
					...
					<div class="panel-body">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input name="newus" class="form-control" placeholder="Enter User name" required>
											</div>
										</div>
										<div class="modal-body">
                                            <div class="form-group">
                        ...
                        if(isset($_POST['in'])) {
                            ...
                            $checkUserQuery = "SELECT * FROM `login` WHERE usname='$newus'";
                            $checkUserResult = mysqli_query($con, $checkUserQuery);

                            if(mysqli_num_rows($checkUserResult) > 0) {
                                echo '<script>alert("User with the same name already exists.");</script>';
                            } else {
                                $newsql ="INSERT INTO login (usname, pass) VALUES ('$newus', '$newps')";
                                if(mysqli_query($con, $newsql)) {
                                    echo '<script>alert("User name and password added.");</script>';
                                }
