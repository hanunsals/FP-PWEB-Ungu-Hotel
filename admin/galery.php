        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  class="active-menu" href="galery.php"><i class="fa fa-plus-circle"></i> Add Gallery</a>
                    </li>
                    <li>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" width='20%'cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><img src="../admin/gambar/<?php echo ($data['gambar']) ?>" class="rounded" width='100%' alt="Cinque Terre"></td>
