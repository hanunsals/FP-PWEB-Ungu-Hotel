                ...
                <div class="row">
                    ...
                    <div class="booking-details">
                        ...
                        <div class="panel-footer">
							...
							<input type="submit" name="co" value="Confirm" class="btn" style="background-color: #792685; color: #fcfcfc">
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														$psql = "INSERT INTO `payment`(`id`, `title`, `fname`, `lname`, `troom`, `nroom`, `cin`, `cout`, `ttot`,`fintot`,`noofdays`) VALUES ('$id','$title','$fname','$lname','$troom','$nroom','$cin','$cout','$ttot','$fintot','$days')";
														
														if(mysqli_query($con,$psql))
														{	$notfree="NotFree";
															$psql = "UPDATE `room` SET `cusid`='$id' where type='$troom' ";
															if(mysqli_query($con,$psql))
															{
