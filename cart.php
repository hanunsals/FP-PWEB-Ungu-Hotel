		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">UNGU <span>hotel</span><p class="logo_w3l_agile_caption">Your Favorite Hotel</p></a></h1>
				</div>
				<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="unguhotel.php" class="menu__link">Home</a></li>
							<li class="menu__item"><a href="about.php" class="menu__link scroll">About</a></li>
							<li class="menu__item"><a href="#" class="menu__link scroll">Team</a></li>
							<li class="menu__item"><a href="unguhotel.php" class="menu__link scroll">Gallery</a></li>
...
<div class="blog-card">
    <div class="meta">
    <img src="../unguhotel/admin/uploaded_img/<?php echo $row['image']; ?>" height="auto" alt="" class="photo">
    <img src="../unguhotel/admin/uploaded_img/<?php echo $row['image']; ?>" height="auto" alt="" >
      <ul class="details">
       
        <li class="tags">$<?php echo $row['price']; ?></li>
      </ul>
    </div>
